                                ...
                                <div class="form-wrap">
                                    <form class="form-horizontal" method="POST" action="{{route('specialist.store')}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="input-group">
                                                    <input type="text" name="specialist" class="form-control" id="exampleInputuname_4" placeholder="Enter Specialist Name">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="input-group">                                                  
                                                    <textarea type="text" name="details" class="form-control" id="exampleInputEmail_4" placeholder="Enter Details Here" rows="10"></textarea>
